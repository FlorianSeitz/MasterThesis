...
\subsection{Appendix}
The following instructions are the original instructions in German used in the experiment. The parts in italic highlight the instructions that were shown only to participants in the condition with time pressure.
...
\subsubsection{Learning phase instructions}
...
\subsubsection{Test phase instructions}
