...
\toprule
\multicolumn{1}{c}{Index} & \multicolumn{1}{c}{Hypothesis} & \multicolumn{1}{c}{Prediction} & \multicolumn{1}{c}{Descriptive Means} & \multicolumn{1}{c}{Betas}\\
\midrule
\addlinespace
\multicolumn{1}{c}{\emph{H1}} & \multicolumn{2}{c}{\emph{With time pressure}} \\
\addlinespace
H1a & people use MULTI-DISC or UNI-DISC, ... & stimulus 100: class ''B'', the others: class ''A'' & -0.18 & 0.86\\
H1b & else UNI-MINK, ...  & stimulus 003: class ''A'', the others: class ''B'' ($w_1$ = 1) \n stimulus 003: class ''B'', the others: class ''A'' ($w_3$ = 1) & -0.21 & 0.83\\
H1c & else MULTI-MINK. & stimulus 100: class ''A'', the others: class ''B'' & 20.56 & <.001\\
H1d & \multicolumn{2}{c}{rank order of model fits at the aggregate level: \n MULTI-DISC = UNI-DISC > UNI-MINK > MULTI-MINK > RANDOM} & 0.09 & -24.28 & <.001\\
H1e & \multicolumn{2}{c}{MULTI-DISC and UNI-DISC describe the most participants} & 0.08 & -10.70 & <.001\\
H1f & \multicolumn{2}{c}{rank order of model fits at the individual level: \n MULTI-DISC = UNI-DISC > UNI-MINK > MULTI-MINK > RANDOM} & 0.09 & 10.81 & <.001\\
\addlinespace
\multicolumn{1}{c}{\emph{H2}} & \multicolumn{2}{c}{\emph{Without time pressure}} \\
\addlinespace
H2a & people use MULTI-MINK. & stimulus 100: class ''A'', the others: class ''B'' & -0.18 & 0.86\\
H2b & \multicolumn{2}{c}{rank order of model fits at the aggregate level: \n MULTI-MINK > {MUTLI-DISC, UNI-DISC, UNI-MINK} > RANDOM} & 0.09 & -24.28 & <.001\\
H2c & \multicolumn{2}{c}{MULTI-MINK describes the most participants \n rank order of model fits at the individual level: \n MULTI-MINK > {MUTLI-DISC, UNI-DISC, UNI-MINK} > RANDOM} & 0.09 & 10.81 & <.001\\
\addlinespace
\multicolumn{1}{c}{\emph{H3}} & \multicolumn{2}{c}{\emph{Across time pressure conditions}} \\
\addlinespace
H3a & \multicolumn{2}{c}{more people use MULTI-DISC with than without time pressure} & 0.18 & -0.18 & 0.86\\
H3b & \multicolumn{2}{c}{more people use MULTI-MINK without than with time pressure} & 0.09 & -24.28 & <.001\\
\bottomrule
\addlinespace
\end{tabular*}
\begin{tablenotes}[para]
