...
The present findings suggest that under time pressure, people do not use the discrete metric. These findings imply that higher cognitive load does not reduce the complexity of psychological distance computation in categorization, but rather increases choice inconsistency. The way psychological distance is computed in categorization is thus independent of the amount of cognitive capacities.
