...
\addlinespace
H3a & more people use MULTI-DISC with than without time pressure & $N_{MULTI-DISC}$ with time pressure > $N_{MULTI-DISC}$ without time pressure\\
\addlinespace
H3b & more people use MULTI-MINK without than with time pressure & $N_{MULTI-MINK}$ with time pressure < $N_{MULTI-MINK}$ without time pressure\\
\bottomrule
\addlinespace
\end{tabular*}
